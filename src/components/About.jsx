      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-lg text-gray-600">
            ...
            spare time, kind of like a hobby, it took a little over a year until
            I made the decision to enroll in a BootCamp where I became a
            passionate full-stack web developer focused on front-end. I am
            currently proficient in JavaScript, React.js & Node.js technologies
            and am learning Next.js and TypeScript. I am used to working under
            pressure, in a team and have a great sense of communication. I
            consider myself a person who adapts to any environment and I am a
            fast learner if required.
          </p>
